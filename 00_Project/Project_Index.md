...
- `README.md`
- `00_Project/Quick_Start.md`
- `00_Project/Directory_Map.md`
...
- Raw material enters through Inbox or save scripts
- Frameworks define how to think
- Templates define how to write
- GitHub preserves history and makes the system easier to expand
